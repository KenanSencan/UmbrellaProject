...
void TimerComponent::Update()
{
    if (m_IsRunning && !m_IsFinished)
    {
        ...
        {
            m_IsFinished = true;
            //we can invoke OnEventFinish at here if desired
        }
    }
}
...
std::chrono::nanoseconds TimerComponent::ConvertToNanos(const float time, const TimeUnit unit)
{
    ...
    switch (unit)
    {
        ...
        case TimeUnit::Microsecond: nanoseconds *= 1000.0; break;
        case TimeUnit::Millisecond: nanoseconds *= 1000000.0; break;
        case TimeUnit::Second: nanoseconds *= 1000000000.0; break;
        case TimeUnit::Minute: nanoseconds *= 60000000000.0; break;
        case TimeUnit::Hour: nanoseconds *= 3600000000000.0; break;
        case TimeUnit::Day: nanoseconds *= 86400000000000.0; break;
        case TimeUnit::Week: nanoseconds *= 604800000000000.0; break;
        case TimeUnit::Month: nanoseconds *= 2629800000000000.0; break;
        case TimeUnit::Year: nanoseconds *= 31557600000000000.0; break;
    }
