...
std::vector<NPC> npcs;
npcs.reserve(5);  // Prevent reallocation - no moves will happen
...
npcs.emplace_back(sf::Vector2f(200.0f, 500.0f), sf::Vector2f(40.0f, 40.0f));
npcs.emplace_back(sf::Vector2f(300.0f, 500.0f), sf::Vector2f(40.0f, 40.0f));
npcs.emplace_back(sf::Vector2f(400.0f, 500.0f), sf::Vector2f(40.0f, 40.0f));
