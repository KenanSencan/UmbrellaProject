...
if (CMAKE_BUILD_TYPE STREQUAL "Debug")
    ...
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "GNU" AND APPLY_SANITIZERS)
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fsanitize=${SANITIZERS} -fno-omit-frame-pointer")
        set(CMAKE_LINKER_FLAGS "${CMAKE_LINKER_FLAGS} -fsanitize=${SANITIZERS}")
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" AND APPLY_SANITIZERS)
    # MSVC AddressSanitizer configuration
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /fsanitize=address /Zi /MDd /FS")
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /fsanitize=address /DEBUG /INCREMENTAL:NO")
        set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /fsanitize=address /DEBUG /INCREMENTAL:NO")
endif ()
